            ...
            <header className='prodact'>
                ...
                <div className="form-prodact w-5/6 mx-auto mt-5 p-16 flex justify-center items-center flex-col">
                    ...
                    <form className='w-full px-16'>
                        ...
                        <input className='block w-full h-14 text-2xl px-5 rounded-full' type="email" id='email' required onChange={(e) => setTest1(e.target.value)} />
                    </form>
                    {number && email ? <NavLink to='/purchase' className='w-full flex justify-end mt-12'><img width="50" height="50" src="https://img.icons8.com/ios/50/ffffff/circled-chevron-right--v1.png" alt="circled-chevron-right--v1" /></NavLink> : <NavLink className='w-full flex justify-end mt-12'><img width="50" height="50" src="https://img.icons8.com/ios/50/ffffff/circled-chevron-right--v1.png" alt="circled-chevron-right--v1" /></NavLink>}
                </div>
            </header>
            <Footer />
        </>
