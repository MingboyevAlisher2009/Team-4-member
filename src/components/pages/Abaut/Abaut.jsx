      ...
      <section className='px-10'>
        <div className="user-card mt-16">
          <div className="user-image">
            <img className='w-96 h-96 bg-cover bg-center rounded-3xl inline' src={img1} alt="" />
          </div>
          <div className="user-info w-1/2 ml-20">
            <h1 className='inline text-5xl text-white'>Alisher</h1>
        ...
        <div className="user-card mt-14">
          <div className="user-image">
            <img className='w-96 h-96 bg-cover bg-center rounded-3xl inline' src={img2} alt="" />
          </div>
          <div className="user-info w-1/2 ml-20">
            <h1 className='inline text-5xl text-white'>Shohjahon</h1>
            <div className="user-bio mt-14">
              <p className='text-white text-lg'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque facilis optio placeat temporibus possimus animi rem quia quisquam laborum, totam reprehenderit illo minus, aspernatur exercitationem laboriosam iusto error nulla nemo? At repellat vero vel cupiditate neque cumque eum accusamus, eveniet voluptate ullam ea architecto animi qui dolore aliquid dolorem voluptas asperiores est iure fugit quisquam? Veritatis vero eum quidem facere?</p>
            </div>
          </div>
        ...
        <div className="user-card mt-14">
          <div className="user-image">
            <img className='w-96 h-96 bg-cover bg-center rounded-3xl inline' src={img3} alt="" />
          </div>
          <div className="user-info w-1/2 ml-20">
            <h1 className='inline text-5xl text-white'>Mustafo</h1>
            <div className="user-bio mt-14">
              <p className='text-white text-lg'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque facilis optio placeat temporibus possimus animi rem quia quisquam laborum, totam reprehenderit illo minus, aspernatur exercitationem laboriosam iusto error nulla nemo? At repellat vero vel cupiditate neque cumque eum accusamus, eveniet voluptate ullam ea architecto animi qui dolore aliquid dolorem voluptas asperiores est iure fugit quisquam? Veritatis vero eum quidem facere?</p>
            </div>
          </div>
        ...
        <div className="user-card mt-14">
          <div className="user-image">
            <img className='w-96 h-96 bg-cover bg-center rounded-3xl inline' src={img4} alt="" />
          </div>
          <div className="user-info w-1/2 ml-20">
            <h1 className='inline text-5xl text-white'>Jonibek</h1>
            <div className="user-bio mt-14">
              <p className='text-white text-lg'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque facilis optio placeat temporibus possimus animi rem quia quisquam laborum, totam reprehenderit illo minus, aspernatur exercitationem laboriosam iusto error nulla nemo? At repellat vero vel cupiditate neque cumque eum accusamus, eveniet voluptate ullam ea architecto animi qui dolore aliquid dolorem voluptas asperiores est iure fugit quisquam? Veritatis vero eum quidem facere?</p>
            </div>
          </div>
        ...
        <div className="user-card mt-14">
          ...
          <div className="user-info w-1/2 ml-20">
            <h1 className='inline text-5xl text-white'>Oyqiz</h1>
            <div className="user-bio mt-14">
              <p className='text-white text-lg'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque facilis optio placeat temporibus possimus animi rem quia quisquam laborum, totam reprehenderit illo minus, aspernatur exercitationem laboriosam iusto error nulla nemo? At repellat vero vel cupiditate neque cumque eum accusamus, eveniet voluptate ullam ea architecto animi qui dolore aliquid dolorem voluptas asperiores est iure fugit quisquam? Veritatis vero eum quidem facere?</p>
            </div>
          </div>
